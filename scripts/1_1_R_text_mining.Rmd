...
They were manually transcribed into a spreadsheet, categorised based on Harris 2002, and cross checked with the entries in Lewis-Short dictionary.
...
EDH_tibble %>% 
  filter(lemma == str_subset(EDH_tibble$lemma, "argentarior"))
```
