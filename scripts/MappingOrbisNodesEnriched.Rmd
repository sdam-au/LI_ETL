...
tm_shape(cities[cities$X1 %in% Lire_increase1,]) +  # most inscriptionsin 1c AD
  tm_symbols(id = "increase1", 
             ...
             alpha = 0.7)+
  tm_layout(main.title = "50BC -AD100: inscription production growth",
            legend.outside = TRUE)
increase_100
```
...
tm_shape(cities[cities$X1 %in% Lire_increase2,]) +  # most inscriptionsin 1c AD
  tm_symbols(id = "increase2", 
             ...
             title.size = "Additional inscriptions",
             alpha = 0.7)+
  tm_layout(main.title = "AD100-200: inscription production growth",
            legend.outside = TRUE)
increase_200
...
tm_shape(cities[cities$X1 %in% Lire_increase3,]) +  # most inscriptionsin 1c AD
  tm_symbols(id = "increase3", 
             size = "increase3", 
             col = "red",
             scale = 4,
             title.size = "Additional inscriptions",
             alpha = 0.7)+
  tm_layout(main.title = "AD200-300: inscription production growth",
            legend.outside = TRUE)
increase_300
```
...
tm_shape(cities[cities$X1 %in% Lire_increase4,]) +  # most inscriptionsin 1c AD
  tm_symbols(id = "increase4", 
             ...
             title.size = "Additional inscriptions",
             alpha = 0.7)+
  tm_layout(main.title = "AD300-350: inscription production growth",
            legend.outside = TRUE)
increase_350
```
